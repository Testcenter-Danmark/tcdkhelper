...
Pakken kan installeres fra [GitHub](https://github.com/). Da repository'et er privat, kræver dette en personlig adgangstoken (PAT), som kan genereres således: https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token
